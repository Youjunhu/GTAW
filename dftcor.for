      ...
      implicit none
      REAL(P_) a,b,corfac,corim,corre,delta,w,endpts(8)
      REAL(P_) a0i,a0r,a1i,a1r,a2i,a2r,a3i,a3r,arg,c,cl,cr,s,sl,sr,t,t2,
     *t4,t6
      real(p_) cth,ctth,spth2,sth,sth4i,stth,th,th2,th4,tmth2,
     *tth4i
      th=w*delta
c      write(*,*) 'th=',th
      if (a.ge.b.or.th.lt.0.d0.or.th.gt.3.1416d0) stop
